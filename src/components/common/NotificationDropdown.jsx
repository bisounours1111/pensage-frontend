        ...
        return (items || []).map((it) => {
            switch (it.type) {
                case "follow_me":
                    return {
                        id: it.id,
                        message: `${it.payload?.user_from?.username ||
                ...
                case "persisted":
                    return {
                        ...
                        message: it.payload?.title
                            ? `${it.payload.title}${it.payload?.message ? ` — ${it.payload.message}` : ""
                            }`
                ...
                case "comment_received":
                    return {
                        id: it.id,
                        message: `Nouveau commentaire reçu sur "${it.payload?.webnovels?.title || "votre histoire"
                            }"`,
                ...
                case "like_received":
                    return {
                        id: it.id,
                        message: `Nouveau like reçu sur "${it.payload?.webnovels?.title || "votre histoire"
                            }"`,
                ...
                case "new_webnovel":
                    return {
                        id: it.id,
                        message: `Nouvelle histoire par ${it.payload?.author?.username ||
                ...
                case "new_episode":
                    return {
                        id: it.id,
                        message: `Nouvel épisode par ${it.payload?.webnovels?.author?.username || "Auteur"
